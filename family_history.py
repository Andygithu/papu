...
def count_genders(people_dict):
    ...
    print(f'Number of males: {number_male}')
    print(f'Number of females: {number_female}')
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        for key, value in people_dict.items():
            #Get the husband name with the husband key and calculate the age when he got married.
            husband_name = people_dict[husband_key]
            man_age = wedding_year - husband_name[BIRTH_YEAR_INDEX]
            #Get the wife name with the wife key and calculate the age when she got married.
            wife_name = people_dict[wife_key]
            women_age = wedding_year - wife_name[BIRTH_YEAR_INDEX]
        print(f'{husband_name[NAME_INDEX]} {man_age}  >  {wedding_year}  <  {wife_name[NAME_INDEX]} {women_age}')
